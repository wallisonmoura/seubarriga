...
describe("Ao salvar uma transferência válida ...", () => {
  ...
  test("Deve retornar o status 201 e o dados da transferência", () => {
    return request(app)
      .post(MAIN_ROUTE)
      .set("authorization", `bearer ${TOKEN}`)
      .send({
  ...
  test("Ambas devem referenciar as transferência que as originou", () => {
    expect(income.transfer_id).toBe(transferId);
    expect(outcome.transfer_id).toBe(transferId);
  });

  test("Ambas devem esta com status de realizadas", () => {
...
describe("Deve alterar uma transferência válida ...", () => {
  let transferId;
  let income;
  let outcome;

  test("Deve retornar o status 200 e o dados da transferência", () => {
    return request(app)
...
describe("Ao remover uma transferênca", () => {
  test("Deve retornar um status 204", () => {
    return request(app)
